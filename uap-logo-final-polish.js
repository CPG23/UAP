(function(){
  ...
  function injectStyle(){
    ...
    style.textContent = [
      ...
      '@keyframes uapNewsTailLive{0%,100%{opacity:.94;filter:blur(.16px) drop-shadow(0 0 9px rgba(0,212,255,.46));}50%{opacity:1;filter:blur(.16px) drop-shadow(0 0 18px rgba(0,255,221,.86)) drop-shadow(0 0 34px rgba(0,132,255,.38));}}',
      ...
      '.brand-title.uap-logo-final{line-height:.82!important;padding-bottom:.20em!important;margin-bottom:-.12em!important;}',
      ...
      '.brand-title.uap-logo-final .uap-news-s::after{height:.16em!important;bottom:-.115em!important;border-radius:.08em!important;filter:blur(.12px) drop-shadow(0 0 8px rgba(0,212,255,.48))!important;}'
    ].join('\n');
