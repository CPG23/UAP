(function(){
  ...
  function injectStyle(){
    ...
    style.textContent = [
      ...
      '.brand-title.uap-brand-logo{background:transparent!important;box-shadow:none!important;}',
      '.brand-title.uap-brand-logo .uap-edge-letter{background:transparent!important;text-shadow:0 1px 0 rgba(255,255,255,.48),0 0 8px rgba(255,255,255,.4),0 0 19px rgba(0,212,255,.38),0 0 34px rgba(0,132,255,.18)!important;filter:none!important;}',
      '.brand-title.uap-brand-logo .uap-news-s::after{height:.07em!important;bottom:.045em!important;background:linear-gradient(90deg,rgba(0,255,221,0),rgba(0,212,255,.35) 12%,rgba(218,255,255,.62) 72%,rgba(255,255,255,.55))!important;filter:blur(.18px)!important;box-shadow:0 0 10px rgba(0,212,255,.32)!important;}'
    ].join('\n');
