(function(){
  ...
  function injectStyle(){
    ...
    style.textContent = [
      ...
      '@keyframes uapNewsTailLive{0%,100%{opacity:.76;filter:blur(.35px) drop-shadow(0 0 8px rgba(0,212,255,.42));}50%{opacity:1;filter:blur(.35px) drop-shadow(0 0 18px rgba(0,255,221,.82)) drop-shadow(0 0 36px rgba(0,132,255,.38));}}',
      ...
      '.uap-logo-final .uap-news-s{transform:translateY(.18em) scaleY(1.28)!important;transform-origin:50% 100%!important;margin-left:.01em!important;margin-bottom:-.16em!important;z-index:3!important;}',
      '.uap-logo-final .uap-news-s::after{content:""!important;position:absolute!important;right:.48em!important;bottom:.035em!important;width:4.95em!important;height:.22em!important;border-radius:.11em!important;background:linear-gradient(90deg,rgba(0,255,221,0),rgba(0,212,255,.54) 12%,rgba(218,255,255,.98) 70%,rgba(255,255,255,.95))!important;filter:blur(.35px) drop-shadow(0 0 8px rgba(0,212,255,.42))!important;animation:uapNewsTailLive 4.8s ease-in-out infinite!important;pointer-events:none!important;z-index:-1!important;}',
      ...
      '.brand-title.uap-logo-final .uap-news-s{transform:translateY(.15em) scaleY(1.2)!important;margin-bottom:-.12em!important;}',
      '.brand-title.uap-logo-final .uap-news-s::after{height:.16em!important;bottom:.03em!important;filter:blur(.24px) drop-shadow(0 0 7px rgba(0,212,255,.34))!important;}'
    ].join('\n');
