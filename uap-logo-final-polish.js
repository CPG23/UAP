(function(){
  ...
  function injectStyle(){
    ...
    style.textContent = [
      ...
      '.brand-title.uap-logo-final .uap-news-s{transform:translateY(.26em) scaleY(1.18)!important;margin-bottom:-.20em!important;}',
      '.brand-title.uap-logo-final .uap-news-s::after{height:.13em!important;bottom:-.08em!important;border-radius:.065em!important;filter:blur(.12px) drop-shadow(0 0 7px rgba(0,212,255,.42))!important;}'
    ].join('\n');
