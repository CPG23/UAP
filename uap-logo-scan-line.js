(function(){
  ...
  function applyLogoScanLine(){
    ...
    style.id = STYLE_ID;
    style.textContent = [
      '@keyframes uapLetterScanOnce{0%,7%{color:#ffffff;-webkit-text-fill-color:#ffffff;text-shadow:0 0 8px rgba(255,255,255,.5),0 0 20px rgba(0,220,255,.36);filter:brightness(1);}22%{color:#9bffff;-webkit-text-fill-color:#9bffff;text-shadow:0 0 16px rgba(155,255,255,1),0 0 44px rgba(0,232,255,1),0 0 76px rgba(0,120,255,.86);filter:brightness(1.7);}42%{color:#00dfff;-webkit-text-fill-color:#00dfff;text-shadow:0 0 20px rgba(0,223,255,1),0 0 56px rgba(0,150,255,1),0 0 86px rgba(0,255,221,.72);filter:brightness(1.52);}72%,100%{color:#ffffff;-webkit-text-fill-color:#ffffff;text-shadow:0 0 10px rgba(255,255,255,.55),0 0 25px rgba(0,220,255,.5);filter:brightness(1.06);}}',
      '@keyframes uapStartupLineSweep{0%{background-position:220% 0;box-shadow:0 0 10px rgba(0,220,255,.45),0 0 24px rgba(0,132,255,.25);}45%{background-position:0 0;box-shadow:0 0 22px rgba(0,255,221,.95),0 0 48px rgba(0,132,255,.65);}100%{background-position:-120% 0;box-shadow:0 0 14px rgba(0,220,255,.72),0 0 30px rgba(0,132,255,.4);}}',
      ...
      '.startup-title::after{height:4px!important;background-size:240% 100%!important;background-image:linear-gradient(90deg,rgba(0,255,221,0),rgba(0,220,255,.45) 14%,#7dffff 36%,#00a6ff 50%,#00ffdd 64%,rgba(0,220,255,.55) 84%,rgba(0,255,221,0))!important;animation:uapStartupLineSweep 3.4s ease-out 1 both!important;}',
      ...
      '@media(max-width:560px){.startup-title .uap-logo-letter{animation-duration:3.6s!important;animation-delay:calc(var(--i) * .105s)!important}.startup-title{top:28px!important}.startup-title::after{bottom:-10px!important;height:4px!important}}'
    ].join('\n');
