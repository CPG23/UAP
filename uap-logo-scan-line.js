(function(){
  ...
  function applyLogoScanLine(){
    ...
    style.textContent = [
      ...
      '.brand-title::after{bottom:-8px!important;height:2px!important;box-shadow:0 0 10px rgba(0,220,255,.7),0 0 22px rgba(0,132,255,.38)!important;}',
      ...
      '@media(max-width:560px){.uap-logo-letter{animation-duration:4.5s!important;animation-delay:calc(var(--i) * .16s)!important}.startup-title{top:28px!important}.startup-title::after{bottom:-10px!important}}'
    ].join('\n');
