#!/usr/bin/env python3
"""Keep the Department of War release summary tied to the release page."""
...
TITLE_RE = re.compile(r"department of war publishes second release of unidentified anomalous phenomena", re.I)
SUMMARY = (
...
def main() -> None:
    ...
    for article in data.get("articles") or []:
        if not isinstance(article, dict) or not TITLE_RE.search(clean(article.get("title"))):
            continue
    ...
    if changed:
        ...
        meta["warReleaseSummaryGuard"] = {
            "policy": "department_of_war_release_summary_from_release_page_v1",
