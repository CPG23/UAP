(function(){
  ...
  function applyLogoScanLine(){
    ...
    style.textContent = [
      ...
      '.startup-title .uap-logo-letter{animation:uapLetterScan 4.8s ease-in-out infinite!important;animation-delay:calc(var(--i) * .18s)!important;}',
      ...
      '@media(max-width:560px){.startup-title .uap-logo-letter{animation-duration:4.5s!important;animation-delay:calc(var(--i) * .16s)!important}.startup-title{top:28px!important}.startup-title::after{bottom:-10px!important}}'
    ].join('\n');
